...
%                           optional, just for mornitoring
%% =========================================================================================================================
function [u, gamma_dot_new, e_pos, e_gamma] = Tracking_Controller_2D(t,Ts,p,psi,pd,pd_dot,pd_gamma,controller_type, gamma_dot_old, vd, gains)
...
R_IB = [cos(psi) -sin(psi);                                                 % rotation matrix from I to B
        sin(psi)  cos(psi)];
e_pos = R_IB'*(p-pd) - epsilon;    
u = Delta_inv*(R_IB'*pd_dot - K*e_pos);                                     % compute linear and angular speeds

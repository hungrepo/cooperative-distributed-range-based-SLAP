function [tf,Ts,MPC,Mode,Noise,Tracker,Target]=TLAT_Initilization()
...
Tracker.Id1.State=[40; 10;0];        % initial position and heading of tracker 
...
%%      tracker 2
Tracker.Id2.State=[-10;-20;pi/2];        % initial position and heading of tracker 
...
%%       Target 1
Target.Id1.PosHat0=Target.Id1.Pos+[10; -20];  % Initial position  
...
%%       Target 2
Target.Id2.PosHat0=Target.Id2.Pos+[-10; 20];  % Initial position  

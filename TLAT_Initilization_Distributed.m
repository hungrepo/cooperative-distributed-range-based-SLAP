function [tf,Ts,MPC,Mode,Noise,Tracker,Target,omega_bar]=TLAT_Initilization_Distributed()
tf=450;                         % simulation time
%tf=250;                         % simulation time
...
% Tracker.Id1.State=[45;10;pi/2];        % initial position and heading of tracker 
...
%%      tracker 2
Tracker.Id2.State=[30;20;pi/2];        % initial position and heading of tracker 
...
% Tracker.Id3.State=[45;10;pi/2];        % initial position and heading of tracker 
...
% 
% Target.Id1.PosHat1=Target.Id1.Pos+[-100; -15];  % Initial position
% Target.Id1.PosHat2=Target.Id1.Pos+[60; -35];  % Initial position
% Target.Id1.PosHat3=Target.Id1.Pos+[-70; 20];  % Initial position

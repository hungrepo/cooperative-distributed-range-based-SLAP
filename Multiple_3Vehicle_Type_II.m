...
%        omega_bar=0.05;
        ...
        Target.Id1.Pos=[20*sin(0.01*t +pi);  0.3*t ];
        Target.Id1.Vel=[0.2*cos(0.01*t+pi); 0.3    ];
...
% Call DEKF
  [Target.Id1.Est1(:,end+1),Target.Id1.Est2(:,end+1),Target.Id1.Est3(:,end+1),P1Out,P2Out,P3Out,Com,d_lk] = DEKF_3V_2D_Event1(r11,r12,r13,Tracker.Id1.Pos,Tracker.Id2.Pos,Tracker.Id3.Pos,Target.Id1.Est1(:,end),Target.Id1.Est2(:,end),Target.Id1.Est3(:,end),P1,P2,P3,Ts,Target.Id1.Depth,t);
%   [Target.Id1.Est1(:,end+1),Target.Id1.Est2(:,end+1),Target.Id1.Est3(:,end+1),P1Out,P2Out,P3Out] = DEKF_3V_2D(r11,r12,r13,Tracker.Id1.Pos,Tracker.Id2.Pos,Tracker.Id3.Pos,Target.Id1.Est1(:,end),Target.Id1.Est2(:,end),Target.Id1.Est3(:,end),P1,P2,P3,Ts,Target.Id1.Depth,t);
...
% duc1=-0*k2*(gamma1_dot(end)-omega_bar);
% duc2=-0*k2*(gamma2_dot(end)-omega_bar);
% duc3=-0*k2*(gamma3_dot(end)-omega_bar);
...
% gamma1_dot(end+1)=omega_bar+uc1;
% gamma1(end+1)=gamma1(end)+Ts*gamma1_dot(end);
...
%  
%  gamma2_dot(end+1)=omega_bar+uc2;
%  gamma2(end+1)=gamma2(end)+Ts*gamma2_dot(end);
...
%  gamma3_dot(end+1)=(omega_bar+uc3);
%  gamma3(end+1)=gamma3(end)+Ts*gamma3_dot(end);
...
Target.Id1.Pos(:,end+1)=[20*sin(0.01*t +pi);  0.3*t ];
Target.Id1.Vel(:,end+1)=[0.2*cos(0.01*t+pi); 0.3    ];
Target.Id1.State=[Target.Id1.Pos;Target.Id1.Vel];

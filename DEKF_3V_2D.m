...
function [Tracker1, Tracker2, Tracker3] = DEKF_3V_2D(Tracker1, Tracker2, Tracker3, Target,Ts,t)
...
% Funsion Step (after receving data from the neighbors)
       % At Tracker 1 
        Tracker1 = fusion(Tracker1,Tracker2);
       % At Tracker 2 
        Tracker2 = fusion(Tracker2,Tracker3);
       % At Tracker 3
        Tracker3 = fusion(Tracker3,Tracker1);
    else

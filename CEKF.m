function [xhat1Out,xhat2Out,P1Out,P2Out] = DEKF(y1,y2,p1,p2,x1hat,x2hat,P1,P2,Ts,depth,t) 
...
pos1_hat=x1hat(1:2);
pos2_hat=x2hat(1:2);
h1hat = norm([pos_hat-p1;depth]);
h2hat = norm([pos_hat-p2;depth]);
...
% Fusion
    ...
    Omega2_fus=Omega1_fus;
    
    delta_q1_fus=(delta_q1+delta_q2)/2;
    delta_q2_fus=delta_q1_cor;

    delta_Omega1_fus=(delta_Omega1 + delta_Omega2)/2;
    delta_Omega2_fus=delta_Omega1_cor;
